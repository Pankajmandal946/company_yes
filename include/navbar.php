...
<div class="container-xxl position-relative p-0" id="home">
    <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="login.php" class="btn btn-light rounded-pill py-2 px-4 ms-3 d-none d-lg-block"><b>LogIn</b></a>
        </div>
    </nav>
    ...
    <div class="container-xxl bg-success hero-header">
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 text-center text-lg-start">
                    <img class="img-fluid rounded animated zoomIn" src="theme/images/tm.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
