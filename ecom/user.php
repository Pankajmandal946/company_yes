                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-check">
                                        <input type="checkbox" style="margin-top:45px; margin-left: 240px;" name="login_access" class="form-check-input" value="1" id="login_access">
                                        <label class="form-check-label" for="login_access" style="margin-top:38px; margin-left: 260px;">Login access:</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-5">
