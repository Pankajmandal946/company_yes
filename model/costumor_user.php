        ...
        if($count>0) {  
            if($this->validate_password($this->password, $row['password'])) {
                if($row['default_password_change']==1) {
                    ...
                    session_start();
                    $_SESSION["c_x_session_status"] = true;
                    $_SESSION["c_x_user_id"] = $row['user_id'];
                    $_SESSION["c_x_user_login_id"] = $row['user_login_id'];
                    $_SESSION["c_x_name"] = $row['name'];
                    $_SESSION["c_x_email_id"] = $row['email_id'];
                    $_SESSION["c_x_mobile_no"] = $row['mobile_no'];
                    $_SESSION["c_x_user_type"] = $row['user_type'];
                    $_SESSION["c_x_username"] = $row['username'];
